<div class="font-[sans-serif] text-[#333] bg-gray-50 flex items-center p-4">
    <div class="w-full max-w-4xl mx-auto my-20">
        <div class="bg-white grid md:grid-cols-2 lg:gap-24 gap-16 w-full sm:p-8 p-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded overflow-hidden">
            <div class="max-md:order-1 space-y-6">
                ...
                <div class="space-y-6">
                    <button type="button" class="w-full px-4 py-3 flex items-center justify-center rounded text-white text-base tracking-wider font-semibold border-none outline-none bg-blue-600 hover:bg-blue-700">
                    ...
                    <button type="button" class="w-full px-4 py-3 flex items-center justify-center rounded text-[#333] text-base tracking-wider font-semibold border-none outline-none bg-gray-100 hover:bg-gray-200">
                    ...
                    <button type="button" class="w-full px-4 py-3 flex items-center justify-center rounded text-white text-base tracking-wider font-semibold border-none outline-none bg-black hover:bg-[#333]">
            ...
            <form class="w-full" action="/register/auth" method="post">
                <div class="mb-8">
                ...
                <p class="text-sm mt-6 text-center">Already have an account? <a href="/login" class="text-blue-600 font-semibold hover:underline ml-1">Login here</a></p>
            </form>
        </div>
    </div>
</div>