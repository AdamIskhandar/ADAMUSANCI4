<div class="font-[sans-serif] text-[#333]">
    <div class="mt-20 flex fle-col items-center justify-center py-6 px-4">
        <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
            <div class="max-md:text-center">
                <h2 class="lg:text-5xl text-4xl font-extrabold lg:leading-[55px]">
                    ADAMUSAN CODEIGNITER PROJECT
                </h2>
                <p class="text-sm mt-6">Simple User AUTH Using SESSION.</p>
                <p class="text-sm mt-10">Don't have an account <a href="/register" class="text-blue-600 font-semibold hover:underline ml-1">Register here</a></p>
            </div>
            <form class="space-y-6 max-w-md md:ml-auto max-md:mx-auto w-full" action="/login/auth" method="post">
                <?php

                if ($flashSession) {
                ?>
                    <p class="text-white bg-red-400 w-60 text-center p-2 rounded-md mx-auto"><?php echo $flashSession ?></p>
                <?php
                }
                ?>
