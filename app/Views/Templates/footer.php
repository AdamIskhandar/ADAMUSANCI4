<div class="">
    <footer class=" mt-10 bg-gray-900 p-10 font-[sans-serif] tracking-wide">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:flex lg:items-center">
                <ul class="flex space-x-6">
                    ...
                    <li>
                        <a href="javascript:void(0)">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="fill-gray-300 hover:fill-white w-7 h-7" viewBox="0 0 24 24">
        ...
        <p class='text-gray-300 text-sm mt-10'>© 2023<a href='https://readymadeui.com/' target='_blank' class="hover:underline mx-1">ReadymadeUI</a>All Rights Reserved.
        </p>
    </footer>
</div>
